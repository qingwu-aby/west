...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-07-02 14:35:12
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `west_cinemas` (
  ...
  PRIMARY KEY (`id`),
  KEY `mid` (`mid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='影讯之影院表' AUTO_INCREMENT=22 ;
...
(1, 1, 'c4418e9b360531699e82eaa6', '西安奥斯卡金地国际影城', '陕西省西安市雁塔区曲江池东路999号金地广场4F', '(029)88639952'),
(2, 1, 'dfba656348903d94430245cf', '西安恒大影城', '西安市雁塔区大寨路99号恒大影城3-4层', '(029)86616468'),
(3, 1, '3018f4615eb0d018a80dd8b8', '大地影院(西安金莎国际)', '西安市雁塔区长安中路65号小寨金莎国际6楼', '(029)89640502'),
(4, 1, 'edd1547d3955c9941e58003c', '西安米格国际影城', '西安市大南门外珠江时代广场世纪金花4F', '(029)85202222'),
(5, 2, 'fb5b13756b7979f9b75f1e45', '西安澳堡开顿国际影城', '西安市长安区西长安街555号澳堡时代广场6F', '(029)65669333'),
(6, 5, '641aa23c0f417cdbe115f902', '卢米埃影城(西安凯德广场店)', '西安市雁塔区南2环西段凯德广场5层(朱雀花卉市场对面)', '(029)88665301'),
(7, 5, '4cee3db92306b7d41e5800c4', '西安耀莱国际影城', '西安市曲江新区大唐不夜城银泰中心4层', '(029)89126600'),
(8, 5, 'd88ce3e10fa05b88902ca358', '万达影城(西安民乐万达广场店)', '解放路中段111号万达百货民乐园店4层', '(029)85450088'),
(9, 5, '1816533448d7db1dfa2d6187', '西安橙天嘉禾影城', '西安市碑林区2环南路西段155号怡丰城3楼3-10号(近太白路立交)', '(029)89194008'),
(10, 5, '4bb049d988306f5e980050f3', '西安万达国际影城(碑林万达广场店)', '西安市碑林区雁塔路北段8号万达广场娱乐楼4层', '(029)85450088'),
(11, 9, 'ebf4adf5e6c07390eb56fa07', '西安万达影城(大明宫店)', '西安市未央区太华北路369号万达广场四层', '(029)85450088'),
(12, 10, 'ebf4adf5e6c07390eb56fa07', '西安万达影城(大明宫店)', '西安市未央区太华北路369号万达广场四层', '(029)85450088'),
(13, 11, 'ebf4adf5e6c07390eb56fa07', '西安万达影城(大明宫店)', '西安市未央区太华北路369号万达广场四层', '(029)85450088'),
(14, 12, 'ebf4adf5e6c07390eb56fa07', '西安万达影城(大明宫店)', '西安市未央区太华北路369号万达广场四层', '(029)85450088'),
(15, 13, 'ebf4adf5e6c07390eb56fa07', '西安万达影城(大明宫店)', '西安市未央区太华北路369号万达广场四层', '(029)85450088'),
(16, 14, 'ebf4adf5e6c07390eb56fa07', '西安万达影城(大明宫店)', '西安市未央区太华北路369号万达广场四层', '(029)85450088'),
(17, 16, 'fff6bbca65d52d027adbd2c9', '西安欢乐小马电影城', '西安市长安中路36号陕西省军区A区军人服务社商业楼8层', '(029)88780818'),
(18, 16, 'ebf4adf5e6c07390eb56fa07', '西安万达影城(大明宫店)', '西安市未央区太华北路369号万达广场四层', '(029)85450088'),
(19, 16, 'dfba656348903d94430245cf', '西安恒大影城', '西安市雁塔区大寨路99号恒大影城3-4层', '(029)86616468'),
(20, 16, '23c94f9ff665c9fb1ef74d42', '大地影院(长安步行街)', '西安市长安区长安步行街北口长百新市购物广场3楼', '(029)63366846'),
(21, 16, 'f4041508bc32ce793310af88', '横店影城（西安中贸店）', '南关正街中茂广场5楼南稍门十字向北100米路西', '029-88669090');
...
INSERT INTO `west_company` (`id`, `uid`, `name`, `mail`, `tel`, `wechat_url`, `introduction`, `detail`, `banner_url`, `modify_time`) VALUES
...
(27, 32, ' 西柚影视集团', 'asdfas', '12341234', 'aasdfasdf', 'asdfasdf', 'asdfasdf', 'asdfasdf', '1435810968');
...
CREATE TABLE IF NOT EXISTS `west_episodes` (
  ...
  `modify_time` varchar(15) NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='剧集表' AUTO_INCREMENT=9 ;

--
-- 转存表中的数据 `west_episodes`
--

INSERT INTO `west_episodes` (`id`, `uid`, `title`, `big_img`, `thumbnail`, `summary`, `author`, `source`, `content`, `views`, `release_time`, `top`, `recommend`, `status`, `modify_time`) VALUES
(1, 13, 'AAAAA', 'no', 'AAAAVVVV', 'DFSFDSFSDxc', 'gDFESDFSDFgh', 'asdSDDSFasdf', '654SDFSDFSDFDSF', 0, '1435810345', 0, 0, 0, '1435810387'),
(2, 13, 'CDSDFDCXZCF', 'no', 'AAAAVVVV', 'DFSFDSFSDxc', 'gDFESDFSDFgh', 'asdSDDSFasdf', '654SDFSDFSDFDSF', 0, '1435810399', 0, 0, 0, '1435840420'),
(3, 13, 'SDFDSDSF', 'no', 'AAAAVVVV', 'DFSFDSFSDxc', 'gDFESDFSDFgh', 'asdSDDSFasdf', '654SDFSDFSDFDSF', 0, '1435810438', 0, 0, 1, '1435810438'),
(4, 13, 'SSDFDXZCXZCF', 'no', 'AAAAVVVV', 'DFSFDSFSDxc', 'gDFESDFSDFgh', 'asdSDDSFasdf', '654SDFSDFSDFDSF', 0, '1435810443', 0, 0, 1, '1435810443'),
(5, 13, 'SSDsdfasdfsCXZCF', 'no', 'AAAAVVVV', 'DFSFDSFSDxc', 'gDFESDFSDFgh', 'asdSDDSFasdf', '654SDFSDFSDFDSF', 0, '1435810446', 0, 0, 1, '1435810446'),
(6, 13, 'SSasdfasdfCXZCF', 'no', 'AAAAVVVV', 'DFSFDSFSDxc', 'gDFESDFSDFgh', 'asdSDDSFasdf', '654SDFSDFSDFDSF', 0, '1435810447', 0, 0, 1, '1435810447'),
(7, 13, 'asdfasdfdfCXZCF', 'no', 'AAAAVVVV', 'DFSFDSFSDxc', 'gDFESDFSDFgh', 'asdSDDSFasdf', '654SDFSDFSDFDSF', 0, '1435810449', 0, 0, 1, '1435810449'),
(8, 13, 'aasdfasdffdfCXZCF', 'no', 'AAAAVVVV', 'DFSFDSFSDxc', 'gDFESDFSDFgh', 'asdSDDSFasdf', '654SDFSDFSDFDSF', 0, '1435810451', 0, 0, 1, '1435810451');
...
CREATE TABLE IF NOT EXISTS `west_links` (
  ...
  `modify_time` varchar(15) NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='友情链接表' AUTO_INCREMENT=49 ;

--
-- 转存表中的数据 `west_links`
--

INSERT INTO `west_links` (`id`, `uid`, `name`, `logo`, `info`, `detail`, `status`, `modify_time`) VALUES
...
(48, 32, 'AAAasdfasdf', 'AAAasdfasdf', 'AAAasdfasdf', 'AAAsfdasdfa', 1, '1435840110');
...
CREATE TABLE IF NOT EXISTS `west_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='操作日志表' AUTO_INCREMENT=447 ;
...
(430, 13, 'add', 'episodes', 1, 'afda', '1435810345'),
(431, 13, 'edit', 'episodes', 1, 'AAAAA', '1435810387'),
(432, 13, 'add', 'episodes', 2, 'AAAAA', '1435810400'),
(433, 13, 'add', 'episodes', 3, 'SDFDSDSF', '1435810438'),
(434, 13, 'add', 'episodes', 4, 'SSDFDXZCXZCF', '1435810443'),
(435, 13, 'add', 'episodes', 5, 'SSDsdfasdfsCXZCF', '1435810446'),
(436, 13, 'add', 'episodes', 6, 'SSasdfasdfCXZCF', '1435810447'),
(437, 13, 'add', 'episodes', 7, 'asdfasdfdfCXZCF', '1435810449'),
(438, 13, 'add', 'episodes', 8, 'aasdfasdffdfCXZCF', '1435810451'),
(439, 13, 'edit', 'episodes', 2, 'CDSDFDCXZCF', '1435810470'),
(440, 13, 'del', 'episodes', 2, 'CDSDFDCXZCF', '1435810478'),
(441, 13, 'del', 'episodes', 1, 'AAAAA', '1435810530'),
(442, 32, 'add', 'video', 39, 'asdfas', '1435839885'),
(443, 32, 'edit', 'video', 39, 'AAA', '1435839936'),
(444, 32, 'add', 'links', 48, 'asdfasdf', '1435840019'),
(445, 32, 'del', 'links', 48, 'asdfasdf', '1435840053'),
(446, 32, 'edit', 'links', 48, 'AAAasdfasdf', '1435840110');
...
CREATE TABLE IF NOT EXISTS `west_movies` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='影讯之电影表' AUTO_INCREMENT=18 ;
...
(1, '侏罗纪世界', '2015-06-12'),
(2, '我是谁2015', '2015-06-12'),
(3, '再见我们的十年', '2015-06-25'),
(4, '我是谁2015', '2015-06-25'),
(5, '分歧者2：绝地反击', '2015-06-25'),
(6, '我是谁2015', '2015-06-27'),
(7, '横冲直撞好莱坞', '2015-06-27'),
(8, '分歧者2：绝地反击', '2015-06-27'),
(9, '横冲直撞好莱坞', '2015-06-27'),
(10, '横冲直撞好莱坞', '2015-06-27'),
(11, '横冲直撞好莱坞', '2015-06-27'),
(12, '横冲直撞好莱坞', '2015-06-27'),
(16, '横冲直撞好莱坞', '2015-06-30'),
(17, '我是谁2015', '2015-07-01');
...
(1, 1, 1, '2015-06-12', '23:05', '3D', '90'),
(2, 1, 2, '2015-06-12', '22:30', '3D', '80'),
(3, 1, 2, '2015-06-12', '23:00', '3D', '80'),
(4, 1, 3, '2015-06-12', '23:00', '3D', '39'),
(5, 1, 4, '2015-06-12', '22:30', '3D', '80'),
(6, 1, 4, '2015-06-12', '23:20', '3D', '80'),
(7, 2, 5, '2015-06-12', '22:40', '2D', '80'),
(8, 5, 6, '2015-06-25', '19:00', '3D', '32.9'),
(9, 5, 6, '2015-06-25', '21:15', '3D', '32.9'),
(10, 5, 7, '2015-06-25', '20:00', '3D', '92.9'),
(11, 5, 7, '2015-06-25', '22:20', '3D', '92.9'),
(12, 5, 8, '2015-06-25', '16:45', '数字3D', '90'),
(13, 5, 8, '2015-06-25', '19:00', '数字3D', '90'),
(14, 5, 8, '2015-06-25', '20:20', '数字3D', '90'),
(15, 5, 8, '2015-06-25', '21:15', '数字3D', '90'),
(16, 5, 8, '2015-06-25', '22:35', 'IMAX', '130'),
(17, 5, 8, '2015-06-25', '23:30', '数字3D', '90'),
(18, 5, 9, '2015-06-25', '17:50', '3D', '100'),
(19, 5, 9, '2015-06-25', '20:00', '3D', '100'),
(20, 5, 9, '2015-06-25', '22:10', '3D', '100'),
(21, 5, 10, '2015-06-25', '17:00', '数字3D', '90'),
(22, 5, 10, '2015-06-25', '19:20', '数字3D', '90'),
(23, 5, 10, '2015-06-25', '21:40', '数字3D', '90'),
(24, 5, 10, '2015-06-25', '22:25', 'IMAX', '130'),
(25, 9, 11, '2015-06-27', '23:25', '数字2D', '75'),
(26, 10, 12, '2015-06-27', '23:25', '数字2D', '75'),
(27, 11, 13, '2015-06-27', '23:25', '数字2D', '75'),
(28, 12, 14, '2015-06-27', '23:25', '数字2D', '75'),
(29, 13, 15, '2015-06-27', '23:25', '数字2D', '75'),
(30, 14, 16, '2015-06-27', '23:25', '数字2D', '75'),
(31, 16, 17, '2015-06-30', '17:15', '2D', '80'),
(32, 16, 17, '2015-06-30', '17:45', '2D', '80'),
(33, 16, 17, '2015-06-30', '19:30', '2D', '80'),
(34, 16, 17, '2015-06-30', '20:15', '2D', '80'),
(35, 16, 17, '2015-06-30', '22:25', '2D', '80'),
(36, 16, 18, '2015-06-30', '17:10', '数字2D', '38'),
(37, 16, 18, '2015-06-30', '18:00', '数字2D', '38'),
(38, 16, 18, '2015-06-30', '18:45', '数字2D', '38'),
(39, 16, 18, '2015-06-30', '19:30', '数字2D', '38'),
(40, 16, 18, '2015-06-30', '20:20', '数字2D', '38'),
(41, 16, 18, '2015-06-30', '21:05', '数字2D', '38'),
(42, 16, 18, '2015-06-30', '21:50', '数字2D', '38'),
(43, 16, 18, '2015-06-30', '22:40', '数字2D', '38'),
(44, 16, 18, '2015-06-30', '23:25', '数字2D', '38'),
(45, 16, 19, '2015-06-30', '16:50', '2D', '100'),
(46, 16, 19, '2015-06-30', '17:35', '2D', '80'),
(47, 16, 19, '2015-06-30', '18:20', '2D', '80'),
(48, 16, 19, '2015-06-30', '19:05', '2D', '100'),
(49, 16, 19, '2015-06-30', '19:50', '2D', '80'),
(50, 16, 19, '2015-06-30', '20:35', '2D', '80'),
(51, 16, 19, '2015-06-30', '21:20', '2D', '100'),
(52, 16, 19, '2015-06-30', '22:05', '2D', '80'),
(53, 16, 19, '2015-06-30', '22:50', '2D', '80'),
(54, 16, 20, '2015-06-30', '22:05', '2D', '34'),
(55, 16, 20, '2015-06-30', '19:50', '2D', '34'),
(56, 16, 20, '2015-06-30', '17:35', '2D', '34'),
(57, 16, 20, '2015-06-30', '20:30', '2D', '34'),
(58, 16, 20, '2015-06-30', '18:15', '2D', '34'),
(59, 16, 20, '2015-06-30', '19:10', '2D', '34'),
(60, 16, 21, '2015-06-30', '18:15', '2D', '80'),
(61, 16, 21, '2015-06-30', '20:30', '2D', '80'),
(62, 16, 21, '2015-06-30', '22:45', '2D', '80');
...
INSERT INTO `west_news` (`id`, `uid`, `title`, `big_img`, `thumbnail`, `summary`, `author`, `source`, `content`, `views`, `release_time`, `hot`, `top`, `recommend`, `status`, `modify_time`) VALUES
...
(13, 'ztf', '900dfd999fc81642102bf60dffc12d5a', 'user', 1, '1432794237'),
...
CREATE TABLE IF NOT EXISTS `west_videos` (
  ...
  `modify_time` varchar(15) NOT NULL COMMENT '操作时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='影视作品表' AUTO_INCREMENT=40 ;

--
-- 转存表中的数据 `west_videos`
--

INSERT INTO `west_videos` (`id`, `uid`, `title`, `url`, `pic`, `detail`, `status`, `recommend`, `top`, `modify_time`) VALUES
(8, 13, '钢铁侠II', 'http://baike.baidu.com/link?url=wSXu74RxKDJOkBDTnKXD0xXtaZePutqEektm8nTiTSRi21xzbkaGUPmFxjnAfy947wSkB9Am2Kll0ozTzkoBhCo9wRu-h34I', '../server/Public/Uploads/2015-06-04/2015060401120413291.jpg', '', 0, 0, 0, '1433351527'),
(9, 13, '雷神II', 'http://baike.baidu.com/link?url=wSXu74RxKDJOkBDTnKXD0xXtaZePutqEektm8nTiTSRi21xzbkaGUPmFxjnAfy947wSkB9Am2Kll0ozTzkoBhCo9wRu-h34I', '../server/Public/Uploads/2015-06-04/2015060401121665662.jpg', '', 0, 0, 0, '1433351538'),
(10, 13, '无敌浩克II', 'http://baike.baidu.com/link?url=wSXu74RxKDJOkBDTnKXD0xXtaZePutqEektm8nTiTSRi21xzbkaGUPmFxjnAfy947wSkB9Am2Kll0ozTzkoBhCo9wRu-h34I', '../server/Public/Uploads/2015-06-04/2015060401130747942.jpg', '', 0, 0, 0, '1433351588'),
(11, 13, '美国队长II', 'http://baike.baidu.com/link?url=wSXu74RxKDJOkBDTnKXD0xXtaZePutqEektm8nTiTSRi21xzbkaGUPmFxjnAfy947wSkB9Am2Kll0ozTzkoBhCo9wRu-h34I', '../server/Public/Uploads/2015-06-04/2015060401225315736.jpg', '', 0, 0, 0, '1433352175'),
(12, 13, '钢铁侠III', 'http://baike.baidu.com/link?url=wSXu74RxKDJOkBDTnKXD0xXtaZePutqEektm8nTiTSRi21xzbkaGUPmFxjnAfy947wSkB9Am2Kll0ozTzkoBhCo9wRu-h34I', '../server/Public/Uploads/2015-06-04/2015060401131723032.jpg', '', 0, 0, 0, '1433351599'),
(13, 13, '复仇者联盟I', 'http://baike.baidu.com/link?url=wSXu74RxKDJOkBDTnKXD0xXtaZePutqEektm8nTiTSRi21xzbkaGUPmFxjnAfy947wSkB9Am2Kll0ozTzkoBhCo9wRu-h34I', '../server/Public/Uploads/2015-06-04/2015060401115356165.jpg', '', 0, 0, 0, '1433351515'),
(16, 13, '复仇者联盟II', 'http://baike.baidu.com/link?url=wSXu74RxKDJOkBDTnKXD0xXtaZePutqEektm8nTiTSRi21xzbkaGUPmFxjnAfy947wSkB9Am2Kll0ozTzkoBhCo9wRu-h34I', '../server/Public/Uploads/2015-06-04/2015060401283735063.jpg', '', 0, 0, 0, '1433352518'),
(17, 13, '银河护卫队', 'http://baike.baidu.com/link?url=wSXu74RxKDJOkBDTnKXD0xXtaZePutqEektm8nTiTSRi21xzbkaGUPmFxjnAfy947wSkB9Am2Kll0ozTzkoBhCo9wRu-h34I', '../server/Public/Uploads/2015-06-04/2015060401113461652.jpg', '', 0, 0, 0, '1433351498'),
(18, 13, '钢铁侠I', 'http://player.youku.com/player.php/sid/XNjI3NjQzOTI4/v.swf', '../server/Public/Uploads/2015-06-04/2015060401093816694.jpg', '', 1, 0, 0, '1433503074'),
(19, 13, '美国队长I', 'http://player.youku.com/player.php/sid/XNjI5MTE2NzE2/v.swf', '../server/Public/Uploads/2015-06-04/2015060401100588091.jpg', '', 1, 0, 0, '1433503035'),
(22, 13, '无敌浩克', 'http://baike.baidu.com/link?url=wSXu74RxKDJOkBDTnKXD0xXtaZePutqEektm8nTiTSRi21xzbkaGUPmFxjnAfy947wSkB9Am2Kll0ozTzkoBhCo9wRu-h34I', '../server/Public/Uploads/2015-06-04/2015060401112228651.jpg', '', 0, 0, 0, '1433351485'),
(25, 13, '重返20岁', 'http://player.youku.com/player.php/sid/XODk0NTQ5MTcy/v.swf', '../server/Public/Uploads/2015-06-09/2015060921453273001.png', '', 1, 0, 0, '1433857533'),
(26, 13, '第七子:降魔之战', 'http://player.youku.com/player.php/sid/XOTA5ODczMzk2/v.swf', '../server/Public/Uploads/2015-06-09/2015060921452563340.png', '', 1, 0, 0, '1433857526'),
(27, 13, '狼图腾', 'http://player.youku.com/player.php/sid/XOTE4MzU2MDE2/v.swf', '../server/Public/Uploads/2015-06-09/2015060921451733424.png', '', 1, 0, 0, '1433857518'),
(28, 13, '一万年以后', 'http://player.youku.com/player.php/sid/XOTM5NDc3MDg4/v.swf', '../server/Public/Uploads/2015-06-09/2015060921441958357.png', '', 1, 0, 0, '1433857460'),
(29, 13, '战狼特攻队', 'http://player.youku.com/player.php/sid/XNDgwODYyNDYw/v.swf', '../server/Public/Uploads/2015-06-09/2015060921441141616.png', '', 1, 0, 0, '1433857453'),
(30, 13, '法老墓的诅咒', 'http://player.youku.com/player.php/sid/XODUwMjkxNTY0/v.swf', '../server/Public/Uploads/2015-06-09/2015060921440399596.png', '', 1, 0, 0, '1433857444'),
(31, 13, '智取威虎山', 'http://player.youku.com/player.php/sid/XODkwNzUzNDQ4/v.swf', '../server/Public/Uploads/2015-06-09/2015060921435418687.png', '', 0, 0, 0, '1433857436'),
(32, 13, 'asfdsa', 'adsafas', '../server/Public/Uploads/2015-06-05/2015060519284140844.png', '', 0, 0, 0, '1433503722'),
(33, 32, ' 失孤', 'http://player.youku.com/player.php/sid/XOTUwMzc1MDI0/v.swf', '../server/Public/Uploads/2015-06-09/2015060922481374888.png', '', 1, 0, 0, '1433861348'),
(34, 32, '饥饿游戏3:嘲笑鸟(上)', 'http://player.youku.com/player.php/sid/XOTEwMjYwMDgw/v.swf', '../server/Public/Uploads/2015-06-09/2015060922495863366.png', '', 1, 1, 1, '1435840316'),
(35, 32, '有种你爱我 ', 'http://player.youku.com/player.php/sid/XOTE1NDAwMzAw/v.swf', '../server/Public/Uploads/2015-06-09/2015060922504973812.png', '', 1, 0, 0, '1433861456'),
(36, 32, '三不管', 'http://player.youku.com/player.php/sid/XODA0NjgyNDAw/v.swf', '../server/Public/Uploads/2015-06-09/2015060922514195259.png', '', 1, 0, 0, '1433861513'),
(37, 32, '出轨的女人', 'http://player.youku.com/player.php/sid/XNjAyNzI2MTQ0/v.swf', '../server/Public/Uploads/2015-06-09/2015060922523452952.png', '', 1, 0, 0, '1433861556'),
(38, 32, '美女敢死队', 'http://player.youku.com/player.php/sid/XODg3ODIxMzI0/v.swf', '../server/Public/Uploads/2015-06-09/2015060922530592394.png', '', 0, 0, 0, '1433861594'),
(39, 32, 'AAA', 'AAAA12341234', 'AAAaasdfasdf', 'AAAasdfasdf', 1, 0, 0, '1435839936');
